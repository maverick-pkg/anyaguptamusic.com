...
DONE = [
    ...
    "All 7 Spotify Canvases uploaded (Sept 13).",
    ...
    "Website release version built and checked by Claude (kept unpublished until the album is streaming).",
]
...
THURSDAY = [
    ...
    ("You + Claude", "Start a Claude session in the anya-site folder and say: “Becoming is live — run the release.”",
     ["Claude pulls every Spotify, Apple and YouTube link itself, fills them in, runs the checks, and shows you the pages.",
    ...
    ("You", "YouTube — switch the four lyric videos from Private to Public.", []),
    ("You", "YouTube — the date swap (files in this folder):",
     ["Channel banner → “channel banner E - OUT NOW.jpg”.",
      ...
      "Album trailer description (and any pinned comment): “out September 18” → “out now”.",
